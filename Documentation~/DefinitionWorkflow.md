# Gameplay-Foundation: definition workflow
...
3. Use its buttons to exercise read stat, increase stat.
4. Inspect the configured hosts and triggers, then open
   [GameplayFoundationWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/GameplayFoundationWorkflow.cs). It is the caller
...
- **Read stat**: `GameplayFoundationWorkflow.Read()`.
- **Increase stat**: `GameplayFoundationWorkflow.Increase()`.
